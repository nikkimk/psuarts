define(["exports","../../../@polymer/polymer/polymer-element.js","../simple-colors-shared-styles.js"],function(_exports,_polymerElement,_simpleColorsSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleColorsStyles=void 0;/**
...
aaLarge:[{min:7,max:12},{min:7,max:12},{min:8,max:12},{min:9,max:12},{min:10,max:12},{min:11,max:12},{min:1,max:2},{min:1,max:3},{min:1,max:4},{min:1,max:5},{min:1,max:6},{min:1,max:6}],aa:[{min:8,max:12},{min:8,max:12},{min:9,max:12},{min:9,max:12},{min:11,max:12},{min:12,max:12},{min:1,max:1},{min:1,max:2},{min:1,max:4},{min:1,max:4},{min:1,max:5},{min:1,max:5}]}};var SimpleColorsStyles=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(SimpleColorsStyles,_PolymerElement);function SimpleColorsStyles(){babelHelpers.classCallCheck(this,SimpleColorsStyles);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleColorsStyles).apply(this,arguments))}babelHelpers.createClass(SimpleColorsStyles,[{key:"getColorInfo",/**
   ...
   */},{key:"shadeToIndex",value:function shadeToIndex(shade){return parseInt(shade)-1}}],[{key:"properties",// properties available to the custom element for data binding
get:function get(){return{/**
      ...
      */contrasts:{type:Object,value:window.SimpleColorsStyles.contrasts}}}/**
 ...
 */window.SimpleColorsStyles.requestAvailability=function(){if(null==window.SimpleColorsStyles.instance){window.SimpleColorsStyles.stylesheet=document.createElement("style");window.SimpleColorsStyles.stylesheet.setAttribute("include","simple-colors-shared-styles");window.SimpleColorsStyles.stylesheet.setAttribute("is","custom-style");document.head.appendChild(window.SimpleColorsStyles.stylesheet);window.SimpleColorsStyles.instance=document.createElement("simple-colors-styles")}return window.SimpleColorsStyles.instance}});