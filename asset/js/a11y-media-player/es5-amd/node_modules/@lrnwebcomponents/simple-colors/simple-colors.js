define(["exports","../../@polymer/polymer/polymer-element.js","../simple-colors-shared-styles/lib/simple-colors-styles.js","../simple-colors-shared-styles/simple-colors-shared-styles.js"],function(_exports,_polymerElement,_simpleColorsStyles,_simpleColorsSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleColors=void 0;function _templateObject_1af9b800f72311e98498d7f727000406(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style include=\"simple-colors-shared-styles\"></style>\n      <slot></slot>\n    "]);_templateObject_1af9b800f72311e98498d7f727000406=function _templateObject_1af9b800f72311e98498d7f727000406(){return data};return data}/**
 * `simple-colors`
...
get:function get(){return(0,_polymerElement.html)(_templateObject_1af9b800f72311e98498d7f727000406())}// properties available to the custom element for data binding
       ...
       * make the default theme dark?
       */colors:{name:"colors",type:Object,value:window.SimpleColorsStyles.colors,notify:!0}}}},{key:"tag",get:function get(){return"simple-colors"}}]);function SimpleColors(){var _this;babelHelpers.classCallCheck(this,SimpleColors);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleColors).call(this));_this.__utils=window.SimpleColorsStyles.requestAvailability();_this.__styles=window.SimpleColorsStyles.stylesheet;return _this}babelHelpers.createClass(SimpleColors,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(SimpleColors.prototype),"connectedCallback",this).call(this);// ensure this only gets applied once even though shouldn't be possible
if(!window.SimpleColorsStylesHead){window.SimpleColorsStylesHead=!0;document.head.appendChild(_simpleColorsSharedStyles.css.content)}}/**
   ...
   */},{key:"isContrastCompliant",value:function isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return this.__utils.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}]);return SimpleColors}(_polymerElement.PolymerElement);_exports.SimpleColors=SimpleColors;window.customElements.define(SimpleColors.tag,SimpleColors)});