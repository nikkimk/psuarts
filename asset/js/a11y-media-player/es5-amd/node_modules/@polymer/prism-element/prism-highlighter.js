define(["./prism-import.js","../polymer/lib/legacy/polymer-fn.js","../polymer/polymer-legacy.js"],function(_prismImport,_polymerFn,_polymerLegacy){"use strict";/**
@license
...
*/(0,_polymerFn.Polymer)({is:"prism-highlighter",properties:{/**
   ...
   */_highlight:function _highlight(event){if(!event.detail||!event.detail.code){_polymerLegacy.Base._warn("Malformed",HIGHLIGHT_EVENT,"event:",event.detail);return}event.stopPropagation();var detail=event.detail;detail.code=Prism.highlight(detail.code,this._detectLang(detail.code,detail.lang))},/**
