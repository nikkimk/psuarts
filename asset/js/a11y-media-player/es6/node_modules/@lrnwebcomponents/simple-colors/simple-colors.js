 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import"../simple-colors-shared-styles/lib/simple-colors-styles.js";import{css as SimpleColorsStyleSheet}from"../simple-colors-shared-styles/simple-colors-shared-styles.js";/**
 * `simple-colors`
...
static get properties(){return{/**
       ...
       * make the default theme dark?
       */colors:{name:"colors",type:Object,value:window.SimpleColorsStyles.colors,notify:!0}}}static get tag(){return"simple-colors"}constructor(){super();this.__utils=window.SimpleColorsStyles.requestAvailability();this.__styles=window.SimpleColorsStyles.stylesheet}connectedCallback(){super.connectedCallback();// ensure this only gets applied once even though shouldn't be possible
if(!window.SimpleColorsStylesHead){window.SimpleColorsStylesHead=!0;document.head.appendChild(SimpleColorsStyleSheet.content)}}/**
   ...
   */isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return this.__utils.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}window.customElements.define(SimpleColors.tag,SimpleColors);export{SimpleColors};