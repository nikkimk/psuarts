...
static get properties(){return{/**
   ...
   */static get tag(){return"a11y-media-play-button"}//inherit styles from a11y-media-player or a11y-media-transcript
...
static get template(){return html`
   ...
   * handle button tap
   */_handleButtonClick(e){this.dispatchEvent(new CustomEvent("controls-change",{detail:this}))}}window.customElements.define(A11yMediaPlayButton.tag,A11yMediaPlayButton);