...
*/import"../polymer/polymer-legacy.js";import"../marked-element/marked-element.js";import"../prism-element/prism-highlighter.js";import"../prism-element/prism-theme-default.js";import{Polymer}from"../polymer/lib/legacy/polymer-fn.js";import{dom}from"../polymer/lib/legacy/polymer.dom.js";import{html}from"../polymer/lib/utils/html-tag.js";/**
...
`,is:"demo-snippet",properties:{/**
     * Fired when the demo-snippet is ready, i.e. when it has injected the code to demo 
     * in the DOM and it can be interacted with
     * 
     * @event dom-ready
     */ /** @private */_markdown:{type:String}},attached:function(){this._observer=dom(this.$.content).observeNodes(function(info){this._updateMarkdown()}.bind(this))},detached:function(){if(this._observer){dom(this.$.content).unobserveNodes(this._observer);this._observer=null}},_updateMarkdown:function(){var template=dom(this).queryDistributedElements("template")[0];// If there's no template, render empty code.
...
dom(this.$.content).unobserveNodes(this._observer);this._observer=null;dom(this).appendChild(document.importNode(template.content,!0))}this.dispatchEvent(new CustomEvent("dom-ready"))},_copyToClipboard:function(){// From
...
setTimeout(this._resetCopyButtonState.bind(this),1e3);selection.removeAllRanges();return result},_resetCopyButtonState:function(){this.$.copyButton.textContent="copy"}});