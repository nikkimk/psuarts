...
*/import"./prism-import.js";import{Polymer}from"../polymer/lib/legacy/polymer-fn.js";import{Base}from"../polymer/polymer-legacy.js";var HIGHLIGHT_EVENT="syntax-highlight";/**
...
*/Polymer({is:"prism-highlighter",properties:{/**
   ...
   */_highlight:function(event){if(!event.detail||!event.detail.code){Base._warn("Malformed",HIGHLIGHT_EVENT,"event:",event.detail);return}event.stopPropagation();var detail=event.detail;detail.code=Prism.highlight(detail.code,this._detectLang(detail.code,detail.lang))},/**
