 ...
 */import{html}from"./node_modules/@polymer/polymer/polymer-element.js";import{afterNextRender}from"./node_modules/@polymer/polymer/lib/utils/render-status.js";import{A11yMediaBehaviors}from"./lib/a11y-media-behaviors.js";import{pathFromUrl}from"./node_modules/@polymer/polymer/lib/utils/resolve-url.js";import{SimpleColors}from"./node_modules/@lrnwebcomponents/simple-colors/simple-colors.js";import"./node_modules/@lrnwebcomponents/es-global-bridge/es-global-bridge.js";import"./lib/a11y-media-state-manager.js";import"./lib/a11y-media-controls.js";import"./lib/a11y-media-html5.js";import"./lib/a11y-media-transcript.js";import"./lib/a11y-media-transcript-controls.js";import"./lib/a11y-media-youtube.js";/**
 * `a11y-media-player`
...
static get properties(){return{/**
   ...
   * plays the media
   */play(){let root=this,stopped=!(!0===root.__playing);if(root.isYoutube&&!root.__ytAppended){ytInit()}else{root.__playing=!0;root.media.play();window.dispatchEvent(new CustomEvent("a11y-player-playing",{detail:root}))}}/**
   * pauses the media
   ...
   */_addSourcesAndTracks(){let root=this,counter=0;console.log("audio",null!==root.querySelector("audio"));root.audioOnly=root.audioOnly||null!==root.querySelector("audio");root.querySelectorAll("source,track").forEach(node=>{if(!root.__captionHref&&"SOURCE"===node.tagName)root.__captionHref=node.getAttribute("src");root.$.html5.media.appendChild(node)});root._appendToPlayer(root.tracks,"track");root._appendToPlayer(root.sources,"source");root.$.html5.media.textTracks.onaddtrack=e=>{root.hasCaptions=!0;root.hasTranscript=!root.standAlone;root._getTrackData(e.track,counter++)}}/**
   ...
   */_getFullscreenButton(disableFullscreen,audioNoThumb,screenfullLoaded){let root=this;if("object"===typeof screenfull)root._onScreenfullLoaded.bind(root);if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||disableFullscreen||audioNoThumb||!("object"===typeof screenfull)){return!1}else{return!0}}/**
   * set play/pause button
   *
